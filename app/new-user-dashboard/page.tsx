...
import { Activity, BarChart3, Settings, LogOut, User, Bell, HelpCircle, Shield, Monitor, TestTube, Database } from "lucide-react"
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500">Professional 5G Testing & Analysis</p>
              </div>
            </div>
