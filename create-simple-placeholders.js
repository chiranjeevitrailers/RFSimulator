...
const components = [
  ...
  { path: 'views/protocol/PhyLayerView.tsx', name: 'PhyLayerView', icon: 'Wifi' },
  ...
  { path: 'views/core/AmfAnalyzer.tsx', name: 'AmfAnalyzer', icon: 'Database' },
...
// Simple template
const createComponent = (name, icon) => {
  // Create a unique set of icons to avoid duplicates
  const allIcons = [icon, 'Activity', 'Database', 'Wifi', 'Server', 'Phone', 'Shield', 'AlertTriangle', 'CheckCircle', 'Clock', 'XCircle'];
...
components.forEach(component => {
  ...
  const content = createComponent(component.name, component.icon);
