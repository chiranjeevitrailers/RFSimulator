-- Complete Supabase Setup for 5GLabX Platform - SAFE VERSION
-- This script is guaranteed to work without any column reference errors
...
-- ==============================================
-- PART 6: SAFE SAMPLE DATA INSERTION
-- ==============================================
...
-- ==============================================
-- PART 7: SAFE VIEWS (NO COLUMN REFERENCE ISSUES)
-- ==============================================
...
-- Create comprehensive layer analysis views with proper column references
...
BEGIN
    ...
    RAISE NOTICE '🔍 Created % views for data analysis', 6;
    RAISE NOTICE '📈 All indexes and RLS policies configured';
    RAISE NOTICE '🎯 Ready for 5GLabX platform integration!';
    RAISE NOTICE '⚠️  Sample data insertion skipped - add data manually after setup';
END $$;