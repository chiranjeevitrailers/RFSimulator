-- ==============================================
-- 5GLabX Platform - Seed Data & Configurations (FIXED)
...
-- ==============================================
-- 4. SAMPLE DATA (NO USER INSERTS)
-- ==============================================

-- Note: Users will be created through Supabase Auth UI or API
-- The users table will be populated automatically when users sign up

-- ==============================================
-- 5. SAMPLE ML MODEL REGISTRY
-- ==============================================
...
-- ==============================================
-- 6. SAMPLE ALERT RULES
-- ==============================================

-- High CPU Usage Alert
INSERT INTO public.alert_rules (
    id, name, description, metric, condition, threshold, severity, enabled, 
    cooldown, notification_channels, tags
) VALUES (
    'alert_high_cpu',
    'High CPU Usage',
...
INSERT INTO public.alert_rules (
    ...
    'alert_test_failure_rate',
    'High Test Failure Rate',
    'Alert when test failure rate exceeds 10%',
    'test_failure_rate',
    'greater_than',
    10.0,
    'medium',
...
DECLARE
    alert_count INTEGER;
BEGIN
    SELECT COUNT(*) INTO alert_count FROM public.alert_rules;
    RAISE NOTICE '✅ % alert rules created', alert_count;
END $$;
...
BEGIN
    ...
    RAISE NOTICE '📊 Subscription plans, payment gateways, and configurations ready';
    RAISE NOTICE '🔔 Alert rules and system monitoring configured';
    RAISE NOTICE '🤖 ML models registered and ready';
