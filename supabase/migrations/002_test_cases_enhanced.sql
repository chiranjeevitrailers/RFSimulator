...
CREATE INDEX IF NOT EXISTS idx_test_cases_protocol_version ON public.test_cases (protocol_version);
...
CREATE INDEX IF NOT EXISTS idx_test_case_templates_protocol_version ON public.test_case_templates (protocol_version);
...
CREATE INDEX IF NOT EXISTS idx_test_case_libraries_protocol_version ON public.test_case_libraries (protocol_version);
