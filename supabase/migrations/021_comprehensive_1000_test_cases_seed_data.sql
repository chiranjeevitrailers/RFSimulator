...
-- 5G NR Categories
('5G NR Initial Access', '5G NR Initial Access', '5G NR initial access procedures', '📡', '#3B82F6', 10, true),
('5G NR Handover', '5G NR Handover', '5G NR handover procedures', '📡', '#3B82F6', 11, true),
('5G NR PDU Session', '5G NR PDU Session', '5G NR PDU session management', '📡', '#3B82F6', 12, true),
('5G NR Mobility', '5G NR Mobility', '5G NR mobility procedures', '📡', '#3B82F6', 13, true),
('5G NR Security', '5G NR Security', '5G NR security procedures', '📡', '#3B82F6', 14, true),
('5G NR Measurement', '5G NR Measurement', '5G NR measurement procedures', '📡', '#3B82F6', 15, true),
('5G NR Power Control', '5G NR Power Control', '5G NR power control procedures', '📡', '#3B82F6', 16, true),
('5G NR Scheduling', '5G NR Scheduling', '5G NR scheduling procedures', '📡', '#3B82F6', 17, true),

-- LTE Categories
('LTE Initial Access', 'LTE Initial Access', 'LTE initial access procedures', '📶', '#10B981', 20, true),
('LTE Handover', 'LTE Handover', 'LTE handover procedures', '📶', '#10B981', 21, true),
('LTE Bearer Management', 'LTE Bearer Management', 'LTE bearer management procedures', '📶', '#10B981', 22, true),
('LTE Mobility', 'LTE Mobility', 'LTE mobility procedures', '📶', '#10B981', 23, true),
('LTE Security', 'LTE Security', 'LTE security procedures', '📶', '#10B981', 24, true),
('LTE Measurement', 'LTE Measurement', 'LTE measurement procedures', '📶', '#10B981', 25, true),
('LTE Power Control', 'LTE Power Control', 'LTE power control procedures', '📶', '#10B981', 26, true),
('LTE Scheduling', 'LTE Scheduling', 'LTE scheduling procedures', '📶', '#10B981', 27, true),

-- IMS/SIP Categories
('IMS Registration', 'IMS Registration', 'IMS registration procedures', '📞', '#8B5CF6', 30, true),
('IMS Call Setup', 'IMS Call Setup', 'IMS call setup procedures', '📞', '#8B5CF6', 31, true),
('IMS Call Release', 'IMS Call Release', 'IMS call release procedures', '📞', '#8B5CF6', 32, true),
('IMS Supplementary Services', 'IMS Supplementary Services', 'IMS supplementary services', '📞', '#8B5CF6', 33, true),
('IMS Emergency Services', 'IMS Emergency Services', 'IMS emergency services', '📞', '#8B5CF6', 34, true),

-- O-RAN Categories
('O-RAN E2 Interface', 'O-RAN E2 Interface', 'O-RAN E2 interface procedures', '🌐', '#F59E0B', 40, true),
('O-RAN A1 Interface', 'O-RAN A1 Interface', 'O-RAN A1 interface procedures', '🌐', '#F59E0B', 41, true),
('O-RAN O1 Interface', 'O-RAN O1 Interface', 'O-RAN O1 interface procedures', '🌐', '#F59E0B', 42, true),

-- V2X Categories
('V2X PC5 Interface', 'V2X PC5 Interface', 'V2X PC5 interface procedures', '🚗', '#EF4444', 50, true),
('V2X Uu Interface', 'V2X Uu Interface', 'V2X Uu interface procedures', '🚗', '#EF4444', 51, true),

-- NTN Categories
('NTN Initial Access', 'NTN Initial Access', 'NTN initial access procedures', '📡', '#3B82F6', 60, true),
('NTN Handover', 'NTN Handover', 'NTN handover procedures', '📡', '#3B82F6', 61, true),

-- NB-IoT Categories
('NB-IoT Initial Access', 'NB-IoT Initial Access', 'NB-IoT initial access procedures', '🔗', '#06B6D4', 70, true),
('NB-IoT Data Transmission', 'NB-IoT Data Transmission', 'NB-IoT data transmission procedures', '🔗', '#06B6D4', 71, true);
...
INSERT INTO public.test_cases (name, description, category_id, category, protocol, protocol_layers, complexity, test_type, test_scenario, test_objective, standard_reference, release_version, duration_minutes, execution_priority, automation_level, test_data_requirements, kpi_requirements) 
SELECT 
