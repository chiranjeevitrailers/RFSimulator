...
CREATE TABLE test_cases (
    ...
    description TEXT,
    category VARCHAR(50) NOT NULL CHECK (category IN ('5G_NR', '4G_LTE', 'IMS', 'O_RAN', 'NB_IoT', 'V2X', 'NTN', 'GCF', 'PTCRB')),
    protocol VARCHAR(50) NOT NULL CHECK (protocol IN ('5G_NR', 'LTE', 'IMS_SIP', 'O_RAN', 'NB_IoT', 'V2X', 'NTN', 'GCF', 'PTCRB')),
